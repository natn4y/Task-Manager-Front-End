...
export function StatusCard({ status, count }: StatusCardProps) {
  ...
  return (
    <div className='flex gap-4 bg-white shadow-sm p-4 rounded-md'>
      <div className={`flex justify-center items-center ${bgColor} p-3 rounded-full w-16 h-16 text-white`}>
        {icon}
      </div>
      <div className='flex flex-col justify-center'>
        <p className={`font-bold ${textColor} text-xl`}>{count}</p>
